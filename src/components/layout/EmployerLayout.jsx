...
function SidebarNavItem({ to, icon: Icon, label, notifCount, onClick }) {
  return (
    ...
    >
      ...
      <span>{label}</span>
      {to === '/employer/notifications' && <NotifBadge count={notifCount} />}
    </NavLink>
  )
}
      ...
      >
        ...
        <div className="flex items-center gap-2 px-5 py-5 border-b border-white/10">
          ...
          <div>
            ...
            <p className="text-[10px] mt-0.5 font-medium" style={{ color: 'rgba(255,255,255,0.45)' }}>Employer Portal</p>
          </div>
        </div>
        ...
        <div className="px-3 py-3 mx-3 mt-3 rounded-2xl border border-white/10"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] mt-0.5 font-medium" style={{ color: '#ef9900' }}>Employer</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-3 py-4 border-t border-white/10 space-y-0.5">
          <SidebarNavItem to="/employer/profile"  icon={User}     label="Profile"  />
          <SidebarNavItem to="/employer/settings" icon={Settings} label="Settings" />
          <button
      ...
      <div className="flex-1 min-w-0 flex flex-col md:ml-60 min-h-screen">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <NavLink to="/employer/notifications" className="relative p-1.5">
