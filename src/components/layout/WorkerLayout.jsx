      ...
      >
        ...
        <div className="px-4 py-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full overflow-hidden shrink-0 flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.2)' }}>
              {profile?.avatar_url
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          {NAV.map(item => (
            ...
            >
              ...
              {item.to === '/worker/notifications' && <NotifBadge count={notifCount} />}
            </NavLink>
          ))}
        </nav>
        ...
        <div className="px-3 py-4 border-t border-white/10 space-y-1">
          <NavItem to="/worker/profile"  icon={User}     label="Profile" />
          <NavItem to="/worker/settings" icon={Settings} label="Settings" />
          <button
