  ...
  return (
    <div className="px-4 sm:px-6 py-6 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="card mb-6 space-y-5">
        ...
        <div>
          <label className="label">Bio <span style={{ color: '#444651' }}>(optional)</span></label>
          <textarea
      ...
      <div className="card mb-6">
        ...
        <p className="text-xs mt-2" style={{ color: '#444651' }}>
          Your rating is built from completed jobs reviewed by employers
        </p>
      </div>

      {/* ---- Danger Zone ---- */}
      <div className="card p-4" style={{ borderColor: '#ffdad6' }}>
        <p className="text-sm font-medium mb-1" style={{ color: '#0b1c30' }}>Account settings</p>
        <p className="text-xs mb-3" style={{ color: '#444651' }}>
          Manage notifications, privacy and account deletion
        </p>
        <Link
          to="/worker/settings"
