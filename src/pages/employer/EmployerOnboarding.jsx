  ...
  async function handleComplete() {
    ...
    try {
      ...
      const fullBio = bio.trim()
        ? categoryLabels
          ? `${bio.trim()}\n\nTypically hires for: ${categoryLabels}`
          : bio.trim()
        : categoryLabels
          ? `Typically hires for: ${categoryLabels}`
          : ''
      ...
      await completeOnboarding(profile.id, updates)
    ...
    >
      ...
      <div className="bg-white rounded-xl shadow-card border w-full max-w-lg p-8" style={{ borderColor: '#c5c5d3' }}>
        ...
        <p className="text-sm text-center mb-6" style={{ color: '#444651' }}>
          {step === 0 && 'Workers will see this when you post a job'}
          {step === 1 && 'Help workers understand what you typically need'}
          {step === 2 && 'A photo builds trust with workers who apply'}
        </p>
        ...
        {step === 1 && (
          <div className="space-y-5">
            <div>
              <label className="label">Describe your hiring needs</label>
              <textarea
                className="input-field resize-none"
                rows={4}
                placeholder="Briefly describe your typical hiring needs..."
                value={bio}
            ...
            <div>
              <label className="label">Job types you typically post</label>
